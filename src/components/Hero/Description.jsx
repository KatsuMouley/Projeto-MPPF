...
const Description = () => {
  return (
    <div className="flex flex-col justify-center items-center p-5 gap-4 max-w-4xl sm:max-w-5xl md:max-w-7xl mx-auto text-left">
      <h1 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-2xl text-center">
        Proteja-se no mundo digital: Conheça, entenda e combata os crimes cibernéticos.
      </h1>
      <p className="text-lg sm:text-xl md:text-xl font-roboto text-center sm:text-left">
